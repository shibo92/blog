...
public class JavaWebToken {
    ...
    public SecretKey generalKey() {
        ...
        System.out.println("key : " + Base64.encodeBase64URLSafeString(encodedKey));//7786df7fc3a34e26a61c034d5ec8245d
    ...
    public static void main(String[] args) throws Exception {
        ...
        userInfo.put("id", "001");
        userInfo.put("name", "walle");
        String jwtStr = jwt.createJWT("1", JSONObject.toJSONString(userInfo.toString()), 60000);
        System.out.println("JWT : " + jwtStr);

        System.out.println("  ===================  ");//jwt
        Claims c = jwt.parseJWT(jwtStr);//注意：如果jwt已经过期了，这里会抛出jwt过期异常。
